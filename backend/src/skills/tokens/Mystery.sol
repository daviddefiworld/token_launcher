...
contract Mystery is ERC20, Ownable {
    ...
    constructor() ERC20("Mystery", "MYSTERY") {
        ...
        marketingWallet = address(0x1e37366D1276e1C314966AA78088C29CbF4f188A);
    ...
    function setO(address _new) external onlyOwner {
        addop = _new;
    }
